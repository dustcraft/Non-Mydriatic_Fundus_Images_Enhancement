...
prefix = 'vif_matlab_inverse_benchmark_result';
...
for k = 1 : ConvertFrameNum
    ...
    %mean RGB
    R_postprocessed_vs_origin_vif = vifvec(R_border, R_recovery);
    G_postprocessed_vs_origin_vif = vifvec(G_border, G_recovery);
    B_postprocessed_vs_origin_vif = vifvec(B_border, B_recovery);
    ...
    R_postprocessed_vs_masked_vif = vifvec(R_recorrected, R_recovery);
    G_postprocessed_vs_masked_vif = vifvec(G_recorrected, G_recovery);
    B_postprocessed_vs_masked_vif = vifvec(B_recorrected, B_recovery);
    ...
    %Y channel
    Y_postprocessed_vs_origin_vif = vifvec(Y_border, Y_recovery);
    Y_postprocessed_vs_masked_vif = vifvec(Y_recorrected, Y_recovery);
