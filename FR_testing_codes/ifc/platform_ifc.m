...
prefix = 'ifc_matlab_recovery_benchmark_result';
...
for k = 1 : ConvertFrameNum
    ...
    %mean RGB
    R_postprocessed_vs_origin_ifc = ifcvec(R_recovery, R_border);
    G_postprocessed_vs_origin_ifc = ifcvec(G_recovery, G_border);
    B_postprocessed_vs_origin_ifc = ifcvec(B_recovery, B_border);
    ...
    R_postprocessed_vs_masked_ifc = ifcvec(R_recovery, R_recorrected);
    G_postprocessed_vs_masked_ifc = ifcvec(G_recovery, G_recorrected);
    B_postprocessed_vs_masked_ifc = ifcvec(B_recovery, B_recorrected);
    ...
    %Y channel
    Y_postprocessed_vs_origin_ifc = ifcvec(Y_recovery, Y_border);
    Y_postprocessed_vs_masked_ifc = ifcvec(Y_recovery, Y_recorrected);
