...
Please cite the following paper when using it:
    ...
    S. Yan, X. Chen, J. Sun, X. Tang and X. Chi, "Non-Mydriatic Fundus Images Enhancement Based on Conformal Mapping Extension," 
    2021 IEEE 7th International Conference on Cloud Computing and Intelligent Systems (CCIS), Xi'an, China, 2021, pp. 218-223, 
    doi: 10.1109/CCIS53392.2021.9754644 .
